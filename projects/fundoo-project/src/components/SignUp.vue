...
<template>
    ...
    <div class="outer">
        ...
        <div class="wrapper">
            <div class="heading">
                <h1 style="font-size: 37px;color: black;">Create a Google Account</h1>
                <div style="font-family: Arial, Helvetica, sans-serif;">Enter your name</div>
            </div>
            <div class="inputs">
                <br>
...
button {
    background-color: rgb(55, 67, 225);
    color: white;
    width: 80px;
    margin-left: 89%;
    cursor: pointer;
